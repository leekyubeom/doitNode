...
/**************사용자 인증 부분*******************/
/**********************************************/
var authUser = function(database , id, password , callack){
    console.log('authUser 호출됨');
    console.dir(database);
    console.log(database + '==' + id + '==' + password);
    //users 컬렉션 참조
    var users = database;
    ...
    users.find({"id" : id , "password" : password}).toArray(function(err,docs){
       ...
       if(docs.length > 0){
           console.log('아이디 %s, 비밀번호 %s가 일지하는 사용자 찾음.',id,password);
           callack(null,docs);
       } else {
